...
\begin{document}
	...
	\begin{itemize}
		...
		\end{verbatim}
	\end{itemize}\par
	Hiện tại gói lệnh \texttt{set\_box} có sẵn $30$, được liệt kê ở mục $3$. Trong đó, kiểu số 0 là kiểu hiển thị không có khung. Đối với các \texttt{theorem} mà thầy cô không muốn tạo khung thì hãy dùng kiểu số $0$ \textit{(đây là bước bắt buộc)}.
	\newpage
